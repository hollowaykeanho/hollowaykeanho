...
____target="${PWD}/interactors/Booleans/Is-False.sh"
...
. "$____target"
command -V Interactors_Booleans_Is_False > /dev/null
if [ $? -ne 0 ]; then
...
____input="true"
____output="$(Interactors_Booleans_Is_False "$____input")"
____process=$?
