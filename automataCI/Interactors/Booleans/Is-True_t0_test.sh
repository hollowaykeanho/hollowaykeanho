...
____target="${PWD}/interactors/Booleans/Is-True.sh"
...
. "$____target"
command -V Interactors_Booleans_Is_True > /dev/null
if [ $? -ne 0 ]; then
...
____input="true"
____output="$(Interactors_Booleans_Is_True "$____input")"
____process=$?
