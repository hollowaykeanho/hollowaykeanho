...
____target="${PWD}/interactors/FS/Is-Directory.sh"
...
. "$____target"
command -V Interactors_FS_Is_Directory > /dev/null
if [ $? -ne 0 ]; then
...
____input="/"
____output="$(Interactors_FS_Is_Directory "$____input")"
____process=$?
