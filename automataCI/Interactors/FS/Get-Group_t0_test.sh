...
____target="${PWD}/interactors/FS/Get-Group.sh"
...
. "$____target"
command -V Interactors_FS_Get_Group > /dev/null
if [ $? -ne 0 ]; then
...
____input_path="."
____output="$(Interactors_FS_Get_Group "$____input_path")"
____process=$?
