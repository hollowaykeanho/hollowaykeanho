...
____target="${PWD}/interactors/FS/Get-Permission.sh"
...
. "$____target"
command -V Interactors_FS_Get_Permission > /dev/null
if [ $? -ne 0 ]; then
...
____input_path="."
____output="$(Interactors_FS_Get_Permission "$____input_path")"
____process=$?
