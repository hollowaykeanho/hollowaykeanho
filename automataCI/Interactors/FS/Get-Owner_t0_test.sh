...
____target="${PWD}/interactors/FS/Get-Owner.sh"
...
. "$____target"
command -V Interactors_FS_Get_Owner > /dev/null
if [ $? -ne 0 ]; then
...
____input_path="."
____output="$(Interactors_FS_Get_Owner "$____input_path")"
____process=$?
