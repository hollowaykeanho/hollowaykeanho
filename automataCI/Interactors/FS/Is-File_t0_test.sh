...
____target="${PWD}/interactors/FS/Is-File.sh"
...
. "$____target"
command -V Interactors_FS_Is_File > /dev/null
if [ $? -ne 0 ]; then
...
____input="/etc/hostname"
____output="$(Interactors_FS_Is_File "$____input")"
____process=$?
