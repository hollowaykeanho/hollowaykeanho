...
____target="${PWD}/interactors/FS/Is-Exist.sh"
...
. "$____target"
command -V Interactors_FS_Is_Exist > /dev/null
if [ $? -ne 0 ]; then
...
____input="/bin"
____output="$(Interactors_FS_Is_Exist "$____input")"
____process=$?
