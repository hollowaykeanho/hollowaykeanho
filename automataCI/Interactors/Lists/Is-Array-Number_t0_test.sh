...
1>&2 printf --  "%s\n" "\
TEST CASE  :
Interactors_List_Is_Array_Number
...
____target="${PWD}/interactors/Lists/Is-Array-Number.sh"
...
. "$____target"
command -V Interactors_List_Is_Array_Number > /dev/null
if [ $? -ne 0 ]; then
...
____input="255, 123, 125, 0, "
____output="$(Interactors_List_Is_Array_Number "$____input")"
____process=$?
