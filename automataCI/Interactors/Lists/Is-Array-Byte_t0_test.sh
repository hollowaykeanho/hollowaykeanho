...
1>&2 printf --  "%s\n" "\
TEST CASE  :
Interactors_List_Is_Array_Byte
...
____target="${PWD}/interactors/Lists/Is-Array-Byte.sh"
...
. "$____target"
command -V Interactors_List_Is_Array_Byte > /dev/null
if [ $? -ne 0 ]; then
...
____output="$(Interactors_List_Is_Array_Byte "$____input")"
____process=$?
