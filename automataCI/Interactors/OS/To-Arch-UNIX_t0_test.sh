...
____target="${PWD}/interactors/OS/To-Arch-UNIX.sh"
...
. "$____target"
command -V Interactors_OS_To_Arch_UNIX > /dev/null
if [ $? -ne 0 ]; then
...
____input="amd64"
____expect="x86_64"
____output="$(Interactors_OS_To_Arch_UNIX "$____input")"
____process=$?
