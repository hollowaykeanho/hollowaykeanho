...
____target="${PWD}/interactors/OS/Is-Color-Mode.sh"
...
. "$____target"
command -V Interactors_OS_Is_Color_Mode > /dev/null
if [ $? -ne 0 ]; then
...
____output="$(Interactors_OS_Is_Color_Mode)"
____process=$?
