...
____target="${PWD}/interactors/OS/To-Arch-MSFT.sh"
...
. "$____target"
command -V Interactors_OS_To_Arch_MSFT > /dev/null
if [ $? -ne 0 ]; then
...
____input="amd64"
____expect="x64"
____output="$(Interactors_OS_To_Arch_MSFT "$____input")"
____process=$?
