...
1>&2 printf --  "%s\n" "\
TEST CASE  :
Interactors_Strings_Trim_Any_Left
...
____target="${PWD}/interactors/Strings/Trim-Any-Left.sh"
...
. "$____target"
command -V Interactors_Strings_Trim_Any_Left > /dev/null
if [ $? -ne 0 ]; then
...
____target="e你f"
____expect="aergaegE你F"
____output="$(Interactors_Strings_Trim_Any_Left "$____input" "$____target")"
____process=$?
