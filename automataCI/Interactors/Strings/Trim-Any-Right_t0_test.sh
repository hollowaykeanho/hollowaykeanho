...
1>&2 printf --  "%s\n" "\
TEST CASE  :
Interactors_Strings_Trim_Any_Right
...
____target="${PWD}/interactors/Strings/Trim-Any-Right.sh"
...
. "$____target"
command -V Interactors_Strings_Trim_Any_Right > /dev/null
if [ $? -ne 0 ]; then
...
____target="E你Fgae"
____expect="e你feeeff你你aer"
____output="$(Interactors_Strings_Trim_Any_Right "$____input" "$____target")"
____process=$?
