...
1>&2 printf --  "%s\n" "\
TEST CASE  :
Interactors_Strings_To_Lowercase
...
____target="${PWD}/interactors/Strings/To-Lowercase.sh"
...
. "$____target"
command -V Interactors_Strings_To_Lowercase > /dev/null
if [ $? -ne 0 ]; then
...
____expect="e你feeeff你你aergaege你f"
____output="$(Interactors_Strings_To_Lowercase "$____input")"
____process=$?
