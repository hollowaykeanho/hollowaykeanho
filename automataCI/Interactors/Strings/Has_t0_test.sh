...
____target="${PWD}/interactors/Strings/Has.sh"
...
. "$____target"
command -V Interactors_Strings_Has > /dev/null
if [ $? -ne 0 ]; then
...
____target="你你a"
____expect="0"
____output="$(Interactors_Strings_Has "$____input" "$____target")"
____process=$?
