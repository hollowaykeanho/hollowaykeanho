...
____target="${PWD}/interactors/Strings/Is-UUID.sh"
...
. "$____target"
command -V Interactors_Strings_Is_UUID > /dev/null
if [ $? -ne 0 ]; then
...
____input="53d88a14-0e76-4c74-b2fc-6d9c1b294da2"
____expect="[NON-EMPTY]"
____output="$(Interactors_Strings_Is_UUID "$____input")"
____process=$?
