...
1>&2 printf --  "%s\n" "\
TEST CASE  :
Interactors_Strings_Is_Whitespace
...
____target="${PWD}/interactors/Strings/Is-Whitespace.sh"
...
. "$____target"
command -V Interactors_Strings_Is_Whitespace > /dev/null
if [ $? -ne 0 ]; then
...
____input=" "
____expect="0"
____output="$(Interactors_Strings_Is_Whitespace "$____input")"
____process=$?
