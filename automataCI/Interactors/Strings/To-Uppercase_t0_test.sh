...
1>&2 printf --  "%s\n" "\
TEST CASE  :
Interactors_Strings_To_Uppercase
...
____target="${PWD}/interactors/Strings/To-Uppercase.sh"
...
. "$____target"
command -V Interactors_Strings_To_Uppercase > /dev/null
if [ $? -ne 0 ]; then
...
____output="$(Interactors_Strings_To_Uppercase "$____input")"
____process=$?
