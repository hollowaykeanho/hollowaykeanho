...
1>&2 printf --  "%s\n" "\
TEST CASE  :
Interactors_Strings_Is_Punctuation
...
____target="${PWD}/interactors/Strings/Is-Punctuation.sh"
...
. "$____target"
command -V Interactors_Strings_Is_Punctuation > /dev/null
if [ $? -ne 0 ]; then
...
____input=","
____expect="0"
____output="$(Interactors_Strings_Is_Punctuation "$____input")"
____process=$?
