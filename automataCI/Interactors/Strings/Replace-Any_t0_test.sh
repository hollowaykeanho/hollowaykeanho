...
____target="${PWD}/interactors/Strings/Replace-Any.sh"
...
. "$____target"
command -V Interactors_Strings_Replace_Any > /dev/null
if [ $? -ne 0 ]; then
...
____target="你r"
____candidate="他他X"
____expect="e他他Xfeeeff他他X他他Xae他他XgaegE他他XF"
____output="$(Interactors_Strings_Replace_Any \
        "$____input" \
        "$____target" \
        "$____candidate" \
)"
