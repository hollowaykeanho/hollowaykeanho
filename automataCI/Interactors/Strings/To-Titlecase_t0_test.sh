...
1>&2 printf --  "%s\n" "\
TEST CASE  :
Interactors_Strings_To_Titlecase
...
____target="${PWD}/interactors/Strings/To-Titlecase.sh"
...
. "$____target"
command -V Interactors_Strings_To_Titlecase > /dev/null
if [ $? -ne 0 ]; then
...
____input="e你fe eeff你\n你aer\tga egE你F"
____expect="E你fe Eeff你
你aer	ga Ege你f"
____output="$(Interactors_Strings_To_Titlecase "$____input")"
____process=$?
