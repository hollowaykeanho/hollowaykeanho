...
____target="${PWD}/interactors/Strings/Get-Last.sh"
...
. "$____target"
command -V Interactors_Strings_Get_Last > /dev/null
if [ $? -ne 0 ]; then
...
____expect="F"
____output="$(Interactors_Strings_Get_Last "$____input")"
____process=$?
