...
1>&2 printf --  "%s\n" "\
TEST CASE  :
Interactors_Strings_Trim_Right
...
____target="${PWD}/interactors/Strings/Trim-Right.sh"
...
. "$____target"
command -V Interactors_Strings_Trim_Right > /dev/null
if [ $? -ne 0 ]; then
...
____target="E你F"
____expect="e你feeeff你你aergaeg"
____output="$(Interactors_Strings_Trim_Right "$____input" "$____target")"
____process=$?
