...
____target="${PWD}/interactors/Strings/Has-Any.sh"
...
. "$____target"
command -V Interactors_Strings_Has_Any > /dev/null
if [ $? -ne 0 ]; then
...
____target="rF你"
____expect="0"
____output="$(Interactors_Strings_Has_Any "$____input" "$____target")"
____process=$?
