...
____target="${PWD}/interactors/Strings/Repeat.sh"
...
. "$____target"
command -V Interactors_Strings_Repeat > /dev/null
if [ $? -ne 0 ]; then
...
____input="e你F"
____input_count=10
____expect="e你Fe你Fe你Fe你Fe你Fe你Fe你Fe你Fe你Fe你F"
____output="$(Interactors_Strings_Repeat "$____input" "$____input_count")"
____process=$?

1>&2 printf --  "Given input            :\n|%s|\n\n" "$____input"
1>&2 printf --  "Given input count      :\n|%s|\n\n" "$____input_count"
