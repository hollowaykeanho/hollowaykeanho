...
____target="${PWD}/interactors/Strings/Trim-Whitespace.sh"
...
. "$____target"
command -V Interactors_Strings_Trim_Whitespace > /dev/null
if [ $? -ne 0 ]; then
...
____input="\r\n\f\te你feeeff你你aergaegE你F    "
____expect="e你feeeff你你aergaegE你F"
____output="$(Interactors_Strings_Trim_Whitespace "$____input")"
____process=$?
