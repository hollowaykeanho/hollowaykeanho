...
____target="${PWD}/interactors/Strings/Get-First.sh"
...
. "$____target"
command -V Interactors_Strings_Get_First > /dev/null
if [ $? -ne 0 ]; then
...
____expect="e"
____output="$(Interactors_Strings_Get_First "$____input")"
____process=$?
