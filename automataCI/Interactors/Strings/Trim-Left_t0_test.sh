...
____target="${PWD}/interactors/Strings/Trim-Left.sh"
...
. "$____target"
command -V Interactors_Strings_Trim_Left > /dev/null
if [ $? -ne 0 ]; then
...
____target="e你f"
____expect="eeeff你你aergaegE你F"
____output="$(Interactors_Strings_Trim_Left "$____input" "$____target")"
____process=$?
