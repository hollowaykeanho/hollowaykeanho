...
HestiaUNICODES_Replace_Right() {
        ...
        while [ ! "$____content_unicode" = "" ]; do
                ...
                if [ $____is_replacing -ne 0 ]; then
                        ____converted="${____current}, ${____converted}"
                        continue
                fi
                ...
                if [ ! "$____current" = "$____from" ]; then
                        ...
                        if [ ! "$____buffer" = "" ]; then
                                ____converted="${____buffer%, }, ${____converted}"
                                ____buffer=""
                        fi
                ...
                if [ ! "$____from_unicode" = "" ]; then
                        ____buffer="${____current}, ${____buffer}"
                        continue
                fi
                ...
                if [ $____ignore -le 0 ]; then
                        if [ ! "$____to_unicode" = "" ]; then
                                ____converted="${____to_unicode}, ${____converted}"
                        fi
